...
class LoginFormMixins(forms.Form):
    email = forms.CharField(widget=forms.EmailInput(attrs={'size':'42', 'style': 'border-radius: 5px; '}))
    password = forms.CharField(widget=forms.PasswordInput(attrs={'size':'42', 'style': 'border-radius: 5px;'}))
